...
namespace qmapcontrol
{
    ...
    MapControl::MapControl(QSize size, MouseMode mousemode, bool showScale, bool showUAV, bool showCrosshairs, QWidget * parent, Qt::WindowFlags windowFlags)
        :   QFrame( parent, windowFlags ),
            m_layermanager(0),
            m_imagemanager(0),
            size(size),
    ...
    void MapControl::paintEvent(QPaintEvent* evnt)
    {
        ...
        if (uavVisible)
        {
            dbPainter.drawPixmap(0,560,30,30,QPixmap(":/new/prefix1/img/wurenji.png"));
        }
    ...
    void MapControl::showUAV(bool visible)
    {
        uavVisible = visible;
    }
