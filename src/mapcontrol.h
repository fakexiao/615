...
namespace qmapcontrol
{
    ...
    public:
         ...
         * @param windowFlags QWidget Window flags
         */
        MapControl ( QSize size, MouseMode mousemode = Panning, bool showScale = false, bool showUAV = false, bool showCrosshairs = true, QWidget * parent = 0, Qt::WindowFlags windowFlags = 0);
